...
RABBITMQ_EXPORT int amqp_encode_table(amqp_bytes_t encoded,
  ...
  RABBITMQ_EXPORT void amqp_create_table(amqp_connection_state_t state,
					 amqp_table_t *output,
					 int initialSize);

  RABBITMQ_EXPORT amqp_table_entry_t *amqp_table_add_entry( amqp_connection_state_t state,
							    amqp_table_t *table,
							    amqp_bytes_t key);

  RABBITMQ_EXPORT amqp_boolean_t amqp_table_add_string(amqp_connection_state_t state,
					     amqp_table_t *output,
					     amqp_bytes_t key,
					     amqp_bytes_t value);

RABBITMQ_EXPORT amqp_boolean_t amqp_table_add_int(amqp_connection_state_t state,
					  amqp_table_t *output,
					  amqp_bytes_t key,
					  int value);
